...
var _moveToGroup = require('pub-comp/moveToGroup');
...
var ManageBatchMoveDialog = (_dec = (0, _reactRedux.connect)((0, _u.mapStateToProps)("manageList", {
  namespace: 'manage'
}), {
  addGroup: addGroup
